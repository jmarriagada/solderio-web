    ...
    <section className="bg-[#141414] py-20 md:py-28 text-center text-white border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <span>El Partner Solar del Sur de Chile</span>
        </motion.div>
        ...
        >
          Construyamos Juntos tu Soberanía Energética
        </motion.h2>
        ...
        >
          ...
          <a
            href="https://wa.me/56987654321?text=Hola,%20me%20gustar%C3%ADa%20conversar%20con%20un%20ingeniero%20de%20SoldeR%C3%ADo"
            target="_blank"
