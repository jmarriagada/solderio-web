    ...
    <section className="bg-[#141414] py-20 md:py-28 text-center text-white border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <span>Garantía Total SoldeRío • 1er Año O&M 100% Gratis</span>
        </motion.div>
        ...
        >
          Tu Proyecto Solar con Respaldo Definitivo
        </motion.h2>
        ...
        >
          Cotiza tu planta solar fotovoltaica con SoldeRío e incluye automáticamente el primer año de mantenimiento preventivo, termografía infrarroja y garantía total de mano de obra.
        </motion.p>
        ...
        >
          ...
          >
            <span>Cotizar Planta con Garantía Total</span>
            <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
          </Link>
          <a
            href="https://wa.me/56987654321?text=Hola,%20quisiera%20consultar%20sobre%20las%20garant%C3%ADas%20y%20planes%20de%20mantenimiento%20SoldeR%C3%ADo"
            target="_blank"
