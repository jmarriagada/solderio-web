...
export function NuestraGarantiaFAQ() {
  const { faqs } = NUESTRA_GARANTIA_DATA;
    ...
    <section className="py-20 md:py-28 px-4 md:px-8 max-w-4xl mx-auto">
      ...
      <div className="text-center mb-14">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-brand-fg tracking-tight">
          Dudas Frecuentes sobre Nuestra Garantía
        </h2>
        <p className="mt-3 text-sm md:text-base text-[#4A4A4A]">
          Todo lo que necesitas saber sobre coberturas, seguros, mano de obra y mantenimiento.
        </p>
      </div>
