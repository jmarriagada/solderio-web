...
import { ArrowRight, ShieldCheck, Award, Wrench, CheckCircle } from "lucide-react";
import { motion } from "framer-motion";
import { HeroHeaderNav } from "@/components/HeroHeaderNav";

export function NuestraGarantiaHeroFrame() {
  return (
        ...
        <div className="relative z-20 w-full flex flex-col items-center">
          ...
          >
            ...
            >
              ...
              <span>Garantía Total SoldeRío • Respaldo por 25 Años</span>
            </motion.div>
            ...
            >
              Tu inversión solar 100% protegida desde el primer día: fusionamos garantías Tier 1 de fábrica, mano de obra cubierta y planes O&M con monitoreo 24/7.
            </motion.p>
          </motion.div>
        </div>
        ...
        <div className="relative z-10 text-center px-6 pb-8 md:pb-12 flex flex-col items-center gap-6">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span>25 Años Rendimiento Tier 1</span>
            </div>
            <span className="text-white/30">•</span>
            <div className="flex items-center gap-2">
              <Wrench className="w-4 h-4 text-emerald-400" />
              <span>1er Año O&M 100% Gratis</span>
            </div>
            <span className="text-white/30">•</span>
            <div className="flex items-center gap-2">
              <CheckCircle className="w-3.5 h-3.5 text-[#FF8300]" />
              <span>Stock Local para Swap Inmediato</span>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <span>Conoce las Coberturas</span>
