          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            {cards.map((card, index) => (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="bg-[#FDFFFE] p-8 md:p-9 rounded-[24px] border border-black/10 flex flex-col justify-between shadow-sm hover:shadow-[0_12px_40px_rgba(255,131,0,0.12)] hover:border-[#FF8300]/30 transition-all duration-300 relative group h-full"
