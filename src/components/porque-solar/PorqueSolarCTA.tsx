...
import { ArrowRight, MessageSquare, Sun } from "lucide-react";
    ...
    <section className="bg-[#141414] py-20 md:py-28 text-center text-white border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <span>Cotización Llave en Mano • SEC Clase A</span>
        </motion.div>
        ...
        >
          ...
          >
            <span>Cotizar Planta Solar</span>
            <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
          </Link>
          <a
            href="https://wa.me/56987654321?text=Hola,%20quisiera%20evaluar%20una%20planta%20solar%20con%20un%20ingeniero%20de%20SoldeR%C3%ADo"
            target="_blank"
