...
import { ArrowRight, Sun, TrendingDown, Zap, ShieldCheck } from "lucide-react";
import { motion } from "framer-motion";
import { HeroHeaderNav } from "@/components/HeroHeaderNav";

export function PorqueSolarHeroFrame() {
  return (
    <section className="w-full h-screen p-3 md:p-5 flex flex-col box-border">
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/solar-panels-roof-residential-sur-chile.jpg"
            alt="Por Qué Elegir Energía Solar SoldeRío"
            fill
            priority
          ...
          <motion.div
            ...
            className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-[#FF8300] rounded-full blur-[170px] pointer-events-none"
          />
        </div>
        ...
        <div className="relative z-20 w-full flex flex-col items-center">
          ...
          <HeroHeaderNav activePage="Descubre" locationText="Sur de Chile" />
          ...
          >
            ...
            >
              ...
              <span>Soberanía Energética • Ley Net Billing 21.118</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-[36px] sm:text-[50px] md:text-[64px] font-bold text-white tracking-[-0.04em] leading-[1.05] mb-3 drop-shadow-sm"
            >
            ...
            >
              Protege tu economía familiar o comercial frente a las alzas históricas de las tarifas eléctricas y genera tu propia energía limpia las 24 horas del día.
            </motion.p>
          </motion.div>
        </div>
        ...
        <div className="relative z-10 text-center px-6 pb-8 md:pb-12 flex flex-col items-center gap-6">
          ...
          >
            <div className="flex items-center gap-2">
              <TrendingDown className="w-4 h-4 text-[#FF8300]" />
              <span>Hasta 90% de Ahorro en Boleta</span>
            </div>
            <span className="text-white/30">•</span>
            <div className="flex items-center gap-2">
              <Zap className="w-4 h-4 text-emerald-400" />
              <span>Respaldo Continuo ante Cortes</span>
            </div>
            <span className="text-white/30">•</span>
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-3.5 h-3.5 text-[#FF8300]" />
              <span>Certificación SEC TE-4</span>
            </div>
          </motion.div>
