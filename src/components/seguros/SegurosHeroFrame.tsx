...
import { ArrowRight, Shield, ShieldCheck, Umbrella, Wind, Flame } from "lucide-react";
import { HeroHeaderNav } from "@/components/HeroHeaderNav";

export function SegurosHeroFrame() {
  return (
    <section className="w-full min-h-[85vh] md:min-h-[90vh] p-3 md:p-5 flex flex-col box-border">
      ...
      >
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[650px] h-[450px] bg-blue-500/15 rounded-full blur-[160px]" />
        ...
        <div className="relative z-20 w-full flex flex-col items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs text-white/90 font-light mb-6 shadow-sm">
              <Shield className="w-3.5 h-3.5 text-[#FF8300]" />
              <span>Protección de Activos Solares en el Sur de Chile</span>
            </div>

            <h1 className="text-3xl sm:text-5xl md:text-6xl font-light tracking-tight text-white mb-6 leading-[1.15]">
              Seguros & Pólizas de <br className="hidden sm:inline" />
              <span className="font-normal text-white">Protección Fotovoltaica</span>
            </h1>

            <p className="text-white/75 text-base md:text-xl font-light max-w-2xl mx-auto leading-relaxed mb-8">
              Tu planta solar es un activo de alto valor. Conoce las coberturas contra temporales, caída de árboles, vientos extremos, granizo y sismos diseñadas para la zona sur.
            </p>
        ...
        <div className="relative z-20 w-full max-w-5xl mx-auto px-6 pb-8 md:pb-12 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded-2xl bg-[#1F1F1F]/80 backdrop-blur-md border border-white/10 flex items-center gap-3.5">
            ...
            <div>
              <span className="text-xs font-semibold text-white block">Vientos & Temporales</span>
              <span className="text-[11px] text-white/60 font-light">Anclajes certificados hasta 140 km/h</span>
            </div>
          </div>

          <div className="p-4 rounded-2xl bg-[#1F1F1F]/80 backdrop-blur-md border border-white/10 flex items-center gap-3.5">
            <div className="w-10 h-10 rounded-xl bg-[#FF8300]/15 text-[#FF8300] flex items-center justify-center flex-shrink-0">
              <Umbrella className="w-5 h-5 stroke-[1.5]" />
            </div>
            <div>
              <span className="text-xs font-semibold text-white block">Daños por Clima</span>
              <span className="text-[11px] text-white/60 font-light">Granizo, ramas y sismos</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-[#1F1F1F]/80 backdrop-blur-md border border-white/10 flex items-center gap-3.5">
            ...
            <div>
              ...
              <span className="text-[11px] text-white/60 font-light">Habilita 100% las pólizas de seguros</span>
            </div>
          </div>
        </div>
      </motion.div>
