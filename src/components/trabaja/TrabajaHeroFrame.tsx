...
import { ArrowRight, Briefcase, Users, Award, ShieldCheck } from "lucide-react";
import { HeroHeaderNav } from "@/components/HeroHeaderNav";

export function TrabajaHeroFrame() {
  return (
    <section className="w-full min-h-[85vh] md:min-h-[90vh] p-3 md:p-5 flex flex-col box-border">
      ...
      >
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[650px] h-[450px] bg-emerald-500/15 rounded-full blur-[160px]" />
        ...
        <div className="relative z-20 w-full flex flex-col items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs text-white/90 font-light mb-6 shadow-sm">
              <Briefcase className="w-3.5 h-3.5 text-[#FF8300]" />
              <span>Oportunidades Laborales en Ingeniería Renovable</span>
            </div>

            <h1 className="text-3xl sm:text-5xl md:text-6xl font-light tracking-tight text-white mb-6 leading-[1.15]">
              Construye el futuro de la <br className="hidden sm:inline" />
            ...
            <p className="text-white/75 text-base md:text-xl font-light max-w-2xl mx-auto leading-relaxed mb-8">
              Buscamos ingenieros eléctricos, técnicos montajistas y asesores comerciales apasionados por la excelencia técnica y el impacto sustentable en Los Ríos, Los Lagos y La Araucanía.
            </p>
        ...
        <div className="relative z-20 w-full max-w-5xl mx-auto px-6 pb-8 md:pb-12 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded-2xl bg-[#1F1F1F]/80 backdrop-blur-md border border-white/10 flex items-center gap-3.5">
            ...
            <div>
              <span className="text-xs font-semibold text-white block">Cultura de Excelencia</span>
              <span className="text-[11px] text-white/60 font-light">Capacitación continua en marcas Tier 1</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-[#1F1F1F]/80 backdrop-blur-md border border-white/10 flex items-center gap-3.5">
            ...
            <div>
              <span className="text-xs font-semibold text-white block">Seguridad en Terreno</span>
              <span className="text-[11px] text-white/60 font-light">EPP certificados y protocolos estrictos</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-[#1F1F1F]/80 backdrop-blur-md border border-white/10 flex items-center gap-3.5">
            ...
            <div>
              <span className="text-xs font-semibold text-white block">Impacto Regional</span>
              <span className="text-[11px] text-white/60 font-light">Liderando la transición energética</span>
            </div>
          </div>
        </div>
      </motion.div>
